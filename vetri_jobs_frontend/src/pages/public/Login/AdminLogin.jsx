...
admin_login_hero_image_url:null,

admin_login_headline:"Complete Control Total Visibility",

admin_login_subheadline:"Manage every user, role and setting across the whole platform.",
...
setError("This is not a super admin account");
...
<div className="placement-split-left admin-theme">
...
{
(branding.admin_login_headline || "Complete Control Total Visibility")
    .split(" ")
    .map((word,index,arr)=>(
...
branding.admin_login_subheadline ||

"Manage every user, role and setting across the whole platform."
...
{
branding.admin_login_hero_image_url ?

<img

src={branding.admin_login_hero_image_url}
...
<span className="floating-chip chip-1"><FaShieldAlt/></span>

<span className="floating-chip chip-2"><FaUsersCog/></span>
...
<p>Sign in to manage the entire Vetri Jobs platform.</p>
...
className="placement-login-btn admin-btn"
