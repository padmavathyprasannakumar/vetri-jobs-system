"""
Creates a Placement Administrator account.

Usage:

    python manage.py create_placement_admin \\
        --email admin@vetrijobs.com \\
...
class Command(BaseCommand):
    ...
    help = "Create a Placement Administrator login account"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            ...
            self.style.SUCCESS(
                ...
                f"Placement admin created: {user.email} "
